...
namespace RandomLib {
  ...
  template<>
  const Random_u32::type MixerMT0<Random_u32>::a0 = 5489ULL;
  template<>
  const Random_u32::type MixerMT0<Random_u32>::a1 = 19650218ULL;
  template<>
  const Random_u64::type MixerMT0<Random_u64>::a0 = 5489ULL;
  template<>
  const Random_u64::type MixerMT0<Random_u64>::a1 = 19650218ULL;
